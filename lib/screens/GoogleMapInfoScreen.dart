...
class GoogleMapInfoScreen extends StatefulWidget {
  final double lat , long;

  const GoogleMapInfoScreen(this.lat, this.long);
  @override
  _GoogleMapInfoScreenState createState() => _GoogleMapInfoScreenState();
}

class _GoogleMapInfoScreenState extends State<GoogleMapInfoScreen> {
  ...
  void setLocation() async {
    ...
    _addMarker(LatLng(widget.lat, widget.long));
